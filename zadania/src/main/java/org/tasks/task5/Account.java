...
// If user creates account without providing delivery address, the account is considered as inactive.
// However, if user provides delivery address, the account is set as active.
//
...
public class Account {
    ...
    public void setEmail(String email) {
        ...
        if(email.matches("^[A-Za-z0-9+_.-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,6}$")) {
            // regex validation if email is in correct format
            this.email = email;
        } else {
